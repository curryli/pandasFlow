...
new_tran_df_2 = new_tran_df_0[new_tran_df_0["label_ori"] == 0]  #孤立森林的正常点里的违约样本
print new_tran_df_2.shape

new_tran_df_3 = new_tran_df_0[new_tran_df_0["label_ori"] == 1]  #孤立森林的正常点里的正常样本
new_tran_df_3 = new_tran_df_3.sample(frac=0.4, replace=False)
print new_tran_df_3.shape


new_tran_df_1 =  new_tran_df[new_tran_df["label_IF"] == -1]       #孤立森林的异常点
print new_tran_df_1.shape

new_tran_df = pd.concat([new_tran_df_1, new_tran_df_2, new_tran_df_3], axis=0 )
