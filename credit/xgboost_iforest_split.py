...
np.savetxt("test_a.csv",cerid_arr.T,delimiter=',', fmt = "%s")
...
np.savetxt("test_b.csv",cerid_arr.T,delimiter=',', fmt = "%s")
###################################################################
...
np.savetxt("test_c.csv",cerid_arr.T,delimiter=',', fmt = "%s")
...
np.savetxt("test_d.csv",cerid_arr.T,delimiter=',', fmt = "%s")
