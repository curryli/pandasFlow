...
#X_test_normal = X_test[X_test['label_filled'] == 0].drop("label_filled",axis=1, inplace=False)
#X_test_outliers = X_test[X_test['label_filled'] == 1].drop("label_filled",axis=1, inplace=False)
