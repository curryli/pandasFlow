...
clf = RandomForestClassifier(n_estimators=20, max_depth=4, min_samples_split=2, max_features="auto", max_leaf_nodes=None, bootstrap=True)
...
print len(tree_list)   #(200L, 1L)   



os.makedirs("GenedTrees/") 
for i in range(len(tree_list)):
    dot_data = tree.export_graphviz(clf.estimators_[i], out_file=None, feature_names=used_cols, filled=True, rounded=True, class_names=["buy", "no_buy"])
