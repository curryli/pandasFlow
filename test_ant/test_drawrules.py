...
#clf = GradientBoostingClassifier(learning_rate=0.11, n_estimators=200,max_depth=4, max_features='sqrt', subsample=0.8, random_state=10, criterion="friedman_mse")
...
dot_data= tree.export_graphviz(sub_tree_42, out_file=None, feature_names=used_cols, filled=True, rounded=True)
...
import pydotplus
graphplus = pydotplus.graph_from_dot_data(dot_data)
graphplus.write_pdf("tree.pdf")