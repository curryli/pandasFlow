...
clf = GradientBoostingClassifier(learning_rate=0.01, n_estimators=500,max_depth=10, min_samples_leaf =60, min_samples_split =1200, max_features=10, subsample=0.7, random_state=10)
