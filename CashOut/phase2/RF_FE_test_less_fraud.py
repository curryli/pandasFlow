...
fraud_test = test_all[test_all.label == 1.0].sample(frac=0.01, replace=False)
normal_test = test_all[test_all.label == 0.0]
test_all=pd.concat([fraud_test,normal_test], axis = 0)
