...
predict=classifier.predict_classes(X_test,batch_size=batchsize) #输出预测结果
...
print ("Recall:", recall) 
#metrics.binary_accuracy(y_test,y_test) #计算预测精度
#metrics.binary_accuracy(predict,predict) #计算预测精度
#print metrics.binary_accuracy(y_test,predict) #计算预测精度
#print metrics.categorical_accuracy_score(y_test,predict)